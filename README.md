...
1) Import project in IntelliJ IDEA as a *Scala* project
1) Run the run configuration named *Start Database*
1) Run the run configuration named *Start Server*
...
1) Run database container by using *docker compose*
