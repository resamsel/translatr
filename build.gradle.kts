...
openApiGenerate {
    ...
    globalProperties.set(
        mapOf(
            "models" to "OidcProviderStatus,AccessTokenDto,PageMetadata,PagedAccessTokenList,ProjectPayload,PagedProjectList,MemberDto,PagedMemberList,MessagePayload,PagedMessageList,LocaleDto,PagedLocaleList,KeyDto,PagedKeyList,GlobalFeatureFlagDto,ResolvedFeatureDto,HealthStatus,StatisticsDto,AuthClientDto,NotificationDto,PagedNotificationList,ActivityDto,AggregateDto,PagedActivityList,PagedAggregateList,FeatureFlagDto,PagedFeatureFlagList,UserDto,PagedUserList",
            "apis" to "",
            "supportingFiles" to ""
        )
    )
