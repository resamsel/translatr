...
openApiGenerate {
    ...
    globalProperties.set(
        mapOf(
            "models" to "OidcProviderStatus,AccessTokenPayload,PageMetadata,PagedAccessTokenList,ProjectPayload,PagedProjectList,MemberDto,PagedMemberList,MessagePayload,PagedMessageList,LocaleDto,PagedLocaleList,KeyDto,PagedKeyList,GlobalFeatureFlagDto,ResolvedFeatureDto",
            "apis" to "",
            "supportingFiles" to ""
        )
    )
