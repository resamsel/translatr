...
const getLoggedInUser = createSelector(getAppState, (state: AppState) => state.me);
...
const getProjects = createSelector(getAppState, (state: AppState) => state.projects);

const getAccessTokens = createSelector(getAppState, (state: AppState) => state.accessTokens);
