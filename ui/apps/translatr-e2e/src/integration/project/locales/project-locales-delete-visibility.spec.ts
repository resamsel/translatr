...
describe('Project Locales Delete Locale Visibility', () => {
  ...
  it('should not show locale delete button for member role Developer', () => {
    // given
  ...
  it('should show locale delete button for member role Translator', () => {
    // given
  ...
  it('should show locale delete button for member role Manager', () => {
    // given
  ...
  it('should show locale delete button for user role Admin', () => {
    // given
