...
test.describe('Project Locales Delete Locale Visibility', () => {
  ...
  test('should not show locale delete button for member role Developer', async ({ page }) => {
    // given
    ...
    // then
    await expect(locales.getLocaleList().locator('confirm-button.delete')).toHaveCount(0);
  });

  test('should show locale delete button for member role Translator', async ({ page }) => {
    // given
    ...
    // then
    await expect(locales.getLocaleList().locator('confirm-button.delete')).toHaveCount(2);
  });

  test('should show locale delete button for member role Manager', async ({ page }) => {
    // given
  ...
  test('should show locale delete button for user role Admin', async ({ page }) => {
    // given
