...
describe('Project Members Add Member Visibility', () => {
  ...
  it('should not show the add member button for member role Developer', () => {
    // given
  ...
  it('should not show the add member button for member role Translator', () => {
    // given
  ...
  it('should show the add member button for member role Manager', () => {
    // given
  ...
  it('should show the add member button for user role Admin', () => {
    // given
